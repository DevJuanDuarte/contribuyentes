      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <form class="max-w-xl mx-auto" method="POST" action="{{ route('contribuyentes.store') }}"
              ...
              <div class="relative z-0 w-full mb-5 group">
                  <label for="tipo_documento" class="block mb-2 text-sm font-medium text-gray-500">Tipo de
                      Documento</label>
              ...
              <template x-if="showRazonSocial">
                  <div class="relative z-0 w-full mb-5 group">
                      <input type="text"
                          ...
                          class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                          placeholder=" " required />
                      <label class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Razón Social</label>
              ...
              {{-- El resto de campos permanecen igual --}}
              <div class="relative z-0 w-full mb-5 group">
