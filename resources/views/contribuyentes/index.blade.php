                            ...
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                                <tr>
                                    <th scope="col" class="px-6 py-3">
                                        Tipo Documento
                                        <input type="text" x-model="search.tipo_documento"
                                    ...
                                    <th scope="col" class="px-6 py-3">
                                        Documento
                                        <input type="text" x-model="search.documento"
                                            class="mt-1 block w-full text-xs border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                            placeholder="Buscar...">
                                    </th>
                                    <th scope="col" class="px-6 py-3">
                                        Nombres
                                        <input type="text" x-model="search.nombres"
                                            class="mt-1 block w-full text-xs border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                            placeholder="Buscar...">
                                    </th>
                                    <th scope="col" class="px-6 py-3">
                                        Apellidos
                                        <input type="text" x-model="search.apellidos"
                                            class="mt-1 block w-full text-xs border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                            placeholder="Buscar...">
                                    </th>
                                    <th scope="col" class="px-6 py-3">
                                        Teléfono
                                        <input type="text" x-model="search.telefono"
                                            class="mt-1 block w-full text-xs border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                            placeholder="Buscar...">
                                    </th>
                                    @role('superadmin')
                                ...
                                <template x-for="contribuyente in filteredContribuyentes" :key="contribuyente.id">
                                    <tr class="bg-white border-b text-center">
                                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap"
                                            x-text="contribuyente.tipo_documento"></td>
                                        ...
                                        @role('superadmin')
                                            <td class="px-6 py-4 h-full">
                                                <div class="flex items-center justify-center">
                                                    <a :href="`/contribuyentes/${contribuyente.id}/edit`"
                                                    ...
                                                    <form :action="`/contribuyentes/${contribuyente.id}`" method="POST"
                                                        class="inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
